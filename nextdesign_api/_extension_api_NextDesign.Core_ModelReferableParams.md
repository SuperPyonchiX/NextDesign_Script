...
[Field](_extension_api_NextDesign.Core_ModelReferableParams_properties_Field.md)

関連付けするフィールド

[Model](_extension_api_NextDesign.Core_ModelReferableParams_properties_Model.md)
