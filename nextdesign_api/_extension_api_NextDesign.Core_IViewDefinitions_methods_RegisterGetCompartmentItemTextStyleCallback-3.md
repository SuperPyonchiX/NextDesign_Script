IViewDefinitions.RegisterGetCompartmentItemTextStyleCallback(string,string,string,Func<INode, int, string, IModel, IStyleProperty, object>,StyleAttributes) メソッド
================================================================================================================================================================
