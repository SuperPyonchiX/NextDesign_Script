ModelEditorSelectionResult インタフェース
==================================
...
[Model](_extension_api_NextDesign.Core_ModelEditorSelectionResult_properties_Model.md)

エディタで表示するモデル  
削除済みのモデル、または編集しているプロジェクト以外のモデルを指定した場合は、エディタで表示しません。