IViewDefinitions.RegisterCompartmentItemTextValueCallback(string,string,string,Func<INode, int, string, IModel, string>,Action<INode, int, string, IModel, string>) メソッド
========================================================================================================================================================================
