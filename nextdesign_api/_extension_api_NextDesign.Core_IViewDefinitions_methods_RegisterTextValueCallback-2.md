IViewDefinitions.RegisterTextValueCallback(string,string,TextTypes,Func<IShape, TextTypes, string, IModel, string>,Action<IShape, TextTypes, string, IModel, string>) メソッド
==========================================================================================================================================================================
